...
COPS := -g -O0 -Wall -nostdlib -mcmodel=medany -mabi=lp64d -march=rv64gcv_zba_zbb_zbc_zbs_zfhmin_zacas_zfa -fno-PIE -fomit-frame-pointer -Wno-builtin-declaration-mismatch -fno-zero-initialized-in-bss -std=gnu11
