...
{
	print("Usage:\n");
	print("1. cd     -- enter int a directory\n");
	print("2. ls     -- list directory contents\n");
	print("3. cat    -- concatenate files and print\n");
	print("4. exit   -- exit fs and return to Shell\n");
	print("5. reader -- show the file contents using reader tool\n\n");
}
