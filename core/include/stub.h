...
struct stub {
	...
	void (*handler)(struct pt_regs * regs, void *priv);
	void *priv;
};
...
int register_stub(const char *name,
		  ...
		  void *priv);
int register_handle_exception_stub_handler(void (*handler)(struct pt_regs * regs, void *priv));
int register_ebreak_stub_handler(void (*handler)(struct pt_regs * regs, void *priv));
