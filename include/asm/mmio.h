...
#define __arch_putw(a,v)		(*(volatile unsigned short *)((unsigned long)(a)) = (v))
...
#define readw(a)	({ unsigned int  __v = __arch_getw(a); __iormb(); __v; })
#define writew(a,v)	({ unsigned int  __v = v; __iowmb(); __arch_putw(a, __v);})
